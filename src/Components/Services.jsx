...
const Services = () => {
  ...
  return (
    <>
      <div
        className="container my-5 bc-im"
        data-aos="fade-up"
      ...
      >
        ...
        >
          ...
          <p className="Heading">
            <strong>What is Front-End Web Development?</strong>
          </p>
          <p>
            Front-End Web Development focuses on creating the visual elements of
            a website or web application that users interact with. It includes
            the layout, design, structure, and functionality.
          </p>
        ...
        >
          ...
          <p>
            <strong>What is Website Hosting?</strong>
          </p>
          <p>
            Website hosting involves renting space on a server where your
            website’s files are stored and made accessible to users worldwide.
          </p>
          <h5 className="sub">What We Offer:</h5>
          <ul>
        ...
        >
          ...
          <p>
            <strong>What is Website Management?</strong>
          </p>
          <p>
            Website management involves maintaining and updating your website to
            ensure it stays relevant, secure, and optimized for performance.
          </p>
          <h5 className="sub">What We Offer:</h5>
          <ul>
        ...
        >
          ...
          <ol>
            ...
            <li>
              Proposal: Detailed proposal outlining scope, pricing, and
              timelines.
            </li>
            <li>Execution: We begin the work and keep you updated.</li>
            <li>
              Ongoing Support: Continuous support and maintenance after launch.
            </li>
          </ol>
        </div>
      </div>
